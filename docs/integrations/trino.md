...
layout: default
title: Trino
description: This section covers how you can start using lakeFS with Trino, is an open source, distributed SQL query engine
parent: Integrations
nav_order: 39
has_children: false
---

# Using lakeFS with Trino
{: .no_toc }
...
Querying data in lakeFS from Trino is the same as querying data in S3 from Trino.
It is done using the [Hive connector](https://trino.io/docs/current/connector/hive.html){:target="_blank"}.
...
Trino uses Hive to write data to S3.
...
Here are some examples based on examples from the [Trino Hive connector documentation](https://trino.io/docs/current/connector/hive.html#examples){:target="_blank"}
